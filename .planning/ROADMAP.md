...
**Plans**: 4 plans
Plans:
- [ ] 04-01-PLAN.md — Shared foundation: translations, TranscriptModal wired, FilterBar, CallsTable, IntentBadge, beneficiaries API + test
...
| 4. Core Dashboard Pages | 0/4 | Not started | - |
