    ...
    <div>
      ...
      <div className="bg-[var(--bg-surface)] border border-[var(--bg-border)] rounded-lg">
        ...
        <CallsTable
          ...
          showDuration={true}
          emptyIcon={<Phone className="w-8 h-8" />}
          emptyHeading={t('empty.noVoiceCalls.heading', language)}
          emptyBody={t('empty.noVoiceCalls.body', language)}
